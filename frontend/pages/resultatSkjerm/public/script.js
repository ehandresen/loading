document.addEventListener('DOMContentLoaded', () => {
    ...
    const setupOptions = () => {
        ...
        const optionTexts = ["Hjelp dem!", "Forlat dem!", "Be om belønning", "Stjel fra dem"];
        ...
        document.getElementById('confirmation-message').textContent = `${options[0].text.toUpperCase()} ER PÅ VEI!`;
    };
